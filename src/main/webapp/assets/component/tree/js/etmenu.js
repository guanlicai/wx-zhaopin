	...
	function node(id,caption,title,url,target,tag,check){
		...
		this.toString = function(tv){
			...
			var eA				= document.createElement("a");
				...
				eA.innerHTML	= "<input type='checkbox' "+checked+" oldMenu='"+oldMenu+"' title='"+me.caption+"' id='"+me.id+"' value='"+me.id+"' parentid='"+me.target+"' name='menubox' onclick='selMenu(this)'>" + (me.caption?show:"");
