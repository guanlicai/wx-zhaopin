...
$(function (){
	$("#newBtn").click(function (){
		window.location.href = "${baseUrl}/admin/activity/void/edit.html";
	});
	
	$("#modifyBtn").click(function (){
		if (JS.selectOne()) {
			window.location.href = "${baseUrl}/admin/activity/void/edit.html?id=" + JS.getSelect();
		} else {
			alert("请选择一条记录");
		}
	});
  ...
  <table class="imgtable">
	<thead>
      <tr>
    	...
    	<th style="text-align:center;" width="150px;">投票人数</th>
