...
$(function (){
	$("#newBtn").click(function (){
		window.location.href = "${baseUrl}/admin/business/introimg/edit.html";
	});
	
	$("#modifyBtn").click(function (){
		if (JS.selectOne()) {
			window.location.href = "${baseUrl}/admin/business/introimg/edit.html?id=" + JS.getSelect();
		} else {
			alert("请选择一条记录");
		}
	});
	...
	$("#delBtn").click(function (){
		if(JS.getSelect()){
	  		JS.deleteDate("${baseUrl}/admin/bussiness/introimg/del.html?ids=" + JS.getSelect());
	  	}
	  	else{
	  		alert("请选择待删除数据");
	  	}
...
<div class="rightinfo">
  ...
  <form action="${baseUrl}/admin/business/introimg/list.html" method="post" name="searchForm" id="searchForm">
  ...
  <table class="imgtable">
	<thead>
      <tr>
    	...
    	<th style="text-align:center;" width="50px;">url</th>
      </tr>
    </thead>
	<tbody>
