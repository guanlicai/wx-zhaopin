...
$(function (){
	$("#newBtn").click(function (){
		window.location.href = "${baseUrl}/admin/business/news/edit.html";
	});
	
	$("#modifyBtn").click(function (){
		if (JS.selectOne()) {
			window.location.href = "${baseUrl}/admin/business/news/edit.html?id=" + JS.getSelect();
		} else {
			alert("请选择一条记录");
		}
	});
...
<div class="rightinfo">
  ...
  <ul class="seachform">
    ...
    <li><label>所属商户</label><input id="name" type="text" value="${name}" class="scinput"></li>
    </c:if>
  ...
  <table class="imgtable">
	<thead>
      <tr>
    	...
    	<th style="text-align:center;" width="200px;">所属商户</th>
    	<th style="text-align:center;" width="50px;">logo</th>
    	<th style="text-align:center;">标题</th>
    	<th style="text-align:center;" width="140px;">创建时间</th>
      </tr>
    </thead>
	<tbody>
	  ...
	  <tr style="text-align:center;">
	  	...
	  	<td>${entity.name}</td>
    	<td><img src="${baseServerUrl}${entity.img}" style="width:100px;height:50px;"/></td>
	    <td>${entity.title}</td>
