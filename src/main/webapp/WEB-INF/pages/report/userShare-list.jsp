...
<!-- 按钮信息 -->
<div class="rightinfo">
	<form id="searchForm" name="searchForm" action="${baseUrl}/admin/reprot/share/list.html" method="post" >
  ...
  <ul class="seachform">
    ...
    <li><label>商户Id</label>
      <input id="bid" type="text" value="${bid}" class="scinput">
    </li>
  ...
  <table class="imgtable">
	<tbody>
	  <tr>
    	<td align="right" width="100px;">发展人数：</td>
    	<td>${total}</td>
      </tr>
    </tbody>
  </table>
