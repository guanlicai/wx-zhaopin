  ...
  <table class="imgtable">
	<thead>
      <tr>
    	...
    	<th width="200px;" style="text-align:center;">消费商家</th>
    	<th width="150px;" style="text-align:center;">订单号</th>
    	<th width="100px;" style="text-align:center;">订单金额</th>
    	<th style="text-align:center;">创建时间</th>
      </tr>
    </thead>
	<tbody>
	  <c:forEach items="${page.resultList}" var="order" varStatus="s">
	  <tr style="text-align:center;">
    	<td><input type="checkbox" name="sbox" value="${order.id}" /></td>
    	<td>${order.bizName}</td>
