...
<script type="text/javascript">
	function submitForm() {
		...
		var url = baseUrl + "/admin/auth/role/user/save.html";
		var data = new Object();
...
<body>
  ...
  <div class="formbody">
	...
	<ul class="forminfo">
      <li><label>选择用户</label><input id="userId" readonly="readonly" name="userId" value="" type="text" class="dfinput" /><i>点击右面用户选择</i></li>
