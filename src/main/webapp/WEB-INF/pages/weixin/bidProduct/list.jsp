...
<script type="text/javascript">
	$(document).ready(function(){
	  ...
	  //admin/wxBidProduct/review.html
...
<div class="rightinfo">
  <div class="tools">
    <ul class="toolbar">
	  ...
	  <c:if test="${type eq 1}">
	  <li id="passBtn" class="click"><span><img src="${baseUrl }/assets/images/t02.png" /></span>通过</li>
	  <li id="unPassBtn" class="click"><span><img src="${baseUrl }/assets/images/t02.png" /></span>不通过</li>
	  </c:if>
	</ul>
	
	<ul class="seachform">
    <li><label>产品标题</label><input id="title" type="text" value="${title}" class="scinput"></li>
  ...
  <table class="imgtable">
	<thead>
      <tr>
    	...
    	<c:if test="${!empty isAdmin && isAdmin }">
	    <th width="120px;" style="text-align:center;">所属商户</th>
	    </c:if>
    	...
    	<th width="80px;" style="text-align:center;">点击数</th>
	...
	<tbody>
	  ...
	  <tr style="text-align:center;">
    	...
    	<c:if test="${!empty isAdmin && isAdmin }">
	    <td width="100px;" style="text-align:center;">${entity.bidName}</td>
	    </c:if>
    	<td>${entity.title}</td>
    	<td align="center"><img src="${baseServerUrl}${entity.logo}" style="width:100px" /></td>
