...
<script type="text/javascript">
	...
	function submitForm() {
		...
		JS.saveDate("form1",baseUrl + "/admin/news/save.html");
...
<body>
  ...
  <form id="form1" action="${baseUrl}/admin/news/save.html" method="post">
  ...
  <div class="formbody">
	...
	<ul class="forminfo">
      ...
      <li>
      	<label>内容</label>
      	<textarea id="content" name="content" class="dfinput" rows="10">${entity.content}</textarea><i>必填</i>
      </li>
